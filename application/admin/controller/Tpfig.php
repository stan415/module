...
class Tpfig extends BasicAdmin
{
     ...
     */
    public $table = 'config';
    public $config_key = 'hzttk:ebece:conf';

    public $readme_key = 'hzttk:ebece:readme';
    ...
    protected function redisSave()
    {
        ...
        if (Cache::set($this->config_key, $arr) && Cache::set($this->readme_key, json_decode($readme['value']))) {
            return true;
        } else {
            return false;
        }
